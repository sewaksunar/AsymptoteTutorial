// Simple Animated Gear Mesh - Frame by Frame
// Generates separate PDF files that can be combined
...
void drawGear(pair center, real rb, real ra, real tp, real rp, real phi_rad, 
              pair ptP, pair ptP1, int numTeeth, real rd, real rotationAngle = 0, int num_points = 35) {
