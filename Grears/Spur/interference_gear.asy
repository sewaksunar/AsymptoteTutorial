// ============================================================
//  Involute Spur-Gear with interference
//  small pinion (N2=12) engaging larger gear (N3=40)
//  standard addendum/dedendum; interference occurs on pinion
// ============================================================
import graph;
unitsize(2.8cm);
...
// choose tall pinion and small gear to force interference
int  N2  = 20,  N3  = 50;            // tooth counts (pinion, gear)
...
// --- interference check: involute from pinion base vs gear dedendum ---
real t_int = sqrt((Rd3/rb2)^2 - 1.0);
bool hasInt = t_int < ta2;
if(hasInt) {
    pair intP = invR(O2, rb2, 0, t_int);
    dot(intP, red+6bp);
    label("interference", intP + (0.1,0.1), red+fontsize(8));
}
