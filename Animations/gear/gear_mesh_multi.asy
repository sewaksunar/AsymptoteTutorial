// Animated Gear Mesh - Multi-Frame Version
// This script generates individual PDF files for each frame
...
for (int frame = 0; frame < numFrames; ++frame) {
  ...
  // Export as multipage PDF by writing to a single output
  shipout(format("frame_%03d", frame));
}
